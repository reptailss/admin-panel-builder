...
import {IPostManager, IPostManagerProvider} from "@postManager/interfaces";
...
export class PostManager<
	Post extends object,
	CreatePost extends object,
> implements IPostManager<Post, CreatePost> {
	...
	constructor(
		...
		public readonly createField: IField<CreatePost>,
		public readonly provider: IPostManagerProvider<Post, CreatePost>
	) {
	}
