...
import { IMultilanguagePostManager, IMultilanguagePostManagerProvider } from "./interfaces";
...
export declare class MultilanguagePostManager<Post extends object, BaseField extends object, MultilanguageField extends object, Locales extends readonly string[] = string[]> implements IMultilanguagePostManager<Post, BaseField, MultilanguageField, Locales> {
    readonly baseField: IField<BaseField>;
    readonly multilanguageField: IField<MultilanguageField>;
    readonly provider: IMultilanguagePostManagerProvider<Post, BaseField, MultilanguageField, Locales>;
    private icon;
    ...
    private locales;
    constructor({ name, baseField, provider, multilanguageField, locales }: {
        name: string;
